           ...
           <center>
            <div class="box">
               ...
               <h3 >Sign In </h3>
                ...
                <div class="mt-3">
                <button type="submit" name = "sbmLogin" class="btn btn-warning" style="margin-left:260px ;">Login</button>
                </div>
                <hr class="mt-5">
                   
                    <p style="display: inline;" > Don't have an account? </p> 
                    <a  href = "../LOGIN/signup.php" style="color:yellow; margin-left:10px;"> Sign up</a> 
